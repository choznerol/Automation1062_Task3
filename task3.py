...
img = cv2.imread('./src/red3.jpg')
mono, color = DetermineColor(img)

markcircles(img, mono)
print(color)

cv2.imshow('Task3', img)
cv2.imwrite('Task3_example.jpg', img)
